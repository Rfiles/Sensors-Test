...
Private Sub Slider1_Change()
    SendData "<ESERVO2_ANGLE=" & Slider1.Value & ">"
    Shape7.FillColor = vbRed
End Sub

Private Sub Slider2_Change()
    SendData "<ESERVO1_ANGLE=" & Slider2.Value & ">"
    Shape2.FillColor = vbRed
End Sub
...
Function eservos_rx()
    ...
    End If
    If id_string = "ESERVOS_LOOPSTOP" Then
...
Private Sub Slider3_Change()
    ...
    SendData "<ESERVO1_DELAY=" & Slider3.Value & ">"
End Sub

Private Sub Slider4_Change()
    'Label1.Caption = Slider4.Value
    SendData "<ESERVO2_DELAY=" & Slider4.Value & ">"
End Sub
